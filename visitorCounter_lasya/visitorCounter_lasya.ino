//this is same code as visitor counter but it has max people limit
...
//  initialDistanceOut = measureDistance(trigPin2, echoPin2);
 ...
 void loop(){ 
  ...
  if (((currentPeople != prevCount) && (currentPeople >= 0 )) && (currentPeople < maxPeople)){
